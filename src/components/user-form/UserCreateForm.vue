    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <div class="row g-3">
          ...
          <AppInput id="postalCode" v-model="user.postalCode" label="Postal Code" required placeholder="Enter Postal Code" />
          <AppInput id="phoneNumber" v-model="user.phoneNumber" label="Phone Number" required placeholder="Enter Phone Number" />
          ...
          <AppInput id="password" v-model="user.password" type="password" label="Password" required placeholder="Enter Password" />
          <AppInput id="confirmPassword" v-model="user.confirmPassword" type="password" label="Confirm Password" required placeholder="Enter Confirm Password" />
